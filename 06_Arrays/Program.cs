...
namespace _06_Arrays
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			//Array.Sort(numbers);//sıralamak için
			...
			////kaçıncı indexi veriyor
			//string[] customers = { "ali", "buse", "ayşenur", "merve", "çınar", "kaya" };
			...
			//{
			//	//$ çift tırnak içinde parametresel ifadeler kullanmaya yarar.
