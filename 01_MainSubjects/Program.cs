...
namespace _01_MainSubjects
{
	internal class Program
	{
		static void Main(string[] args)
		{
			...
			//         Console.WriteLine("***** Yemek Kamtegorileri *****");
			//         Console.WriteLine();
			...
			int totalPrice = totalCokePrice + totalLemonadeCount + totalWaterPrice + totalHamburgerPrice + totalPizzaPrice + totalFriesPrice;
